...
# Get all existing designations to avoid duplicates
existing_designations = set(Designation.objects.values_list('name', flat=True))
...
for department in created_departments:
    if department.name in designations_data:
        ...
        for designation_data in designations_data[department.name]:
            ...
            if designation_data['name'] not in existing_designations:
                try:
                    ...
                    existing_designations.add(designation_data['name'])
                except Exception as e:
                    print(f"  ❌ Error creating {designation_data['name']}: {e}")
            else:
                print(f"  📋 Already exists: {designation_data['name']}")
